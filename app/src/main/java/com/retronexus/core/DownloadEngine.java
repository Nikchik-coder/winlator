...
public class DownloadEngine {
    ...
    private static void applyPreset(Context context, Container container, Game game, String mode) {
        ...
        String screenSize = "performance".equals(effectiveMode) ? "800x600" : "1280x720";
        String dxwrapper = "performance".equals(effectiveMode) ? DXWrappers.WINED3D : DXWrappers.DXVK;
    ...
    private static String chooseAutoMode(Context context) {
        try {
            ...
            if (am != null) {
                ...
                if (totalGb > 0 && totalGb <= 6) return "performance";
            }
